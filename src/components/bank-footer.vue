<template>
    <footer id="footer">
        <div class="container">
            <div v-for="footerItem in footerItemList" class="link-block-corp" :key="footerItem">
                <div href="#">
                    <p v-text="footerItem"></p>
                </div>
            </div>
            <div class="copyright">はらネット銀行株式会社 <br class="smartphone-only">登録金融機関 関東財務局長（登金）第665号<br class="smartphone-only"> 一般社団法人 金融先物取引業協会加入</div>
            <div class="copyright">Copyright © Hara Net Bank, Ltd. All Rights Reserved.</div>
        </div>
        <div class="button-top">
            <div class="container">
                <!-- tabキー対策 フォーカス可能な最終要素にfocusFirstChildを設定 必ず一番最終になるように -->
                <a href="#" @click.prevent="onClickTop" @focus="focusFirstChild">
